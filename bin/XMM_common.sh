...
elif [ -d ${BIN}/../heasoft-6.12/i386-apple-darwin10.8.0 ] ; then
	export HEADAS=`expand ${BIN}/../heasoft-6.12/i386-apple-darwin10.8.0`
fi
...
elif [ -d ${BIN}/../sas/xmmsas_20110223_1803/ ] ; then
        export SAS_DIR=`expand ${BIN}/../sas/xmmsas_20110223_1803/`
fi

if [ -d /usr/local/XMM/CCF ] ; then
        export SAS_CCFPATH=/usr/local/XMM/CCF
elif [ -d ${BIN}/../sas/CCF ] ; then
